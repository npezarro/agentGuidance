...
Claude Code session ends
  ...
  → Posts as a private draft to pezant.ca via WP REST API
```
...
2. `$HOME/.env`
3. `/home/generatedByTermius/.env`

## Setup by Environment

### This VM (wordpress-7-vm) — Already Done

Credentials live in `/home/generatedByTermius/.env`:
...
1. Log in to WordPress admin: `https://pezant.ca/wp-admin/`
...
| Setting | Value |
|---------|-------|
| Site | `https://pezant.ca` |
| API endpoint | `https://pezant.ca/wp-json/wp/v2/posts` |
