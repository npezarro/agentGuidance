...
This caused 3 failed PRs on assortedLLMTasks (2026-04-05) before the root cause was identified. Always test Python code against 3.9 syntax rules before deploying to the VM.
