...
### Runner
- Location: `~/repos/autonomousDev/learning-agent/`
...
- Also skips if autonomousDev or fix-checker is currently running (check PM2 / pidfile)
...
- Lists all repos to scan (from autonomousDev config.json)
...
|---|---|
| autonomousDev | Reads its progress logs; doesn't compete for resources |
