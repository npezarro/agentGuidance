...
Every Claude Code response is automatically posted as a **private WordPress draft** on pezant.ca via a Stop hook. Your response IS the blog post — it gets published directly. Write accordingly.
