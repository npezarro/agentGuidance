...
- **`recurring-tasks/`**: shared runner + 3 task configs (job-search, application-materials, company-ranking) with flock-based locking, scoped permissions, Discord notifications, and crontab generator
