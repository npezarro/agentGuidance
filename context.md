...
2026-03-04 — Removed Discord Integration section (moved to discord-bot repo)
...
## Recent Changes
- Removed Discord Integration section from `agent.md` — moved to `discord-bot/docs/discord-agent-guide.md` to keep agent.md focused on universal rules
